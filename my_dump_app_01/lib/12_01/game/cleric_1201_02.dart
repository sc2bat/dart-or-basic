...
void main() {
  final cle1 = Cleric1201_02('Aseosu', hp: 30, mp: 5);
  cle1.showInfo();

  final cle2 = Cleric1201_02('Aseosu', hp: 20);
  cle2.showInfo();

  final cle3 = Cleric1201_02('Aseosu');
  cle3.showInfo();

  /**
    cleric name : Aseosu hp : 30 mp : 5 
    cleric name : Aseosu hp : 20 mp : 10 
    cleric name : Aseosu hp : 50 mp : 10
   */
}
